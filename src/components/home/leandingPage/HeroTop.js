...
export default function HeroTop() {
  return (
    ...
    >
      ...
      <div>
        <div className="px-6 py-4 bg-zinc-500/30 max-md:-mt-10 max-md:text-[3.5vw] md:text-[1.3vw] font-['f2'] font-[900] uppercaseleading-[1] tracking-wider border border-white backdrop-blur-xs rounded-md cursor-pointer hover:bg-green-500/30 hover:text-zinc-200 ease-in-out duration-200">
          join membership
        </div>
      </div>
    </div>
